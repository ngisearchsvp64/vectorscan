...
if(CMAKE_COMPILER_IS_GNUCC)
    # spurious warnings?
    set(EXTRA_C_FLAGS "${EXTRA_C_FLAGS} -Wno-array-bounds -Wno-uninitialized") #-Wno-maybe-uninitialized")
endif()
...
if(CMAKE_COMPILER_IS_GNUCC)
    ...
    CHECK_C_COMPILER_FLAG("-Wstringop-overread" CC_STRINGOP_OVERREAD)
    CHECK_CXX_COMPILER_FLAG("-Wstringop-overread" CXX_STRINGOP_OVERREAD)
    if(CC_STRINGOP_OVERREAD OR CXX_STRINGOP_OVERREAD)
        set(EXTRA_C_FLAGS "${EXTRA_C_FLAGS} -Wno-stringop-overread")
        set(EXTRA_CXX_FLAGS "${EXTRA_CXX_FLAGS} -Wno-stringop-overread")
    endif()
endif()
